			...
			<div class="row">
				<div class="col-md-2">
					...
					<div class="home-page-user">
						<div class="user-info clearfix">
							<img src="media/users/<?php echo $login_user['photo']; ?>" alt="">
                            <a href="profile.php"><h4><?php echo $login_user['name']; ?></h4></a>
						</div>
						...
						<ul>
							...
							<li><a href="#"><img src="assets/media/img/icons/4.png" alt=""> Friends List</a></li>
				...
				<div class="col-md-7">
					...
					<div class="all-post-area">
                        ...
                        $udata = $connection ->query($qry);
                        $user_data = $udata->fetch_assoc();
								...
								<div class="card-body">
									<div class="post-header clearfix">
										...
										<div class="post-user-info">
											<h4><a href="view.php?profile_id=<?php echo $user_data['id'];?>"><?php echo $post['name']; ?></a></h4>

											<p><?php echo $post['created_at']; ?> mins <i class="fas
											fa-globe-americas"></i></p>
										</div>
